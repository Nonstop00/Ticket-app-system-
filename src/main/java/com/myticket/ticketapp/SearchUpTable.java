...
public class SearchUpTable {
        public static void viewAdminuser(TableView tablename, TableColumn tokenCol, TableColumn dateCol, TableColumn ticketsCol, TableColumn pickupCol, TableColumn dropCol, TableColumn stateCol, TableColumn userId,String Searchpar)throws SQLException {
        ...
        WHERE Token = ?
        """);
            viewAdminuser.setString(1,Searchpar);
